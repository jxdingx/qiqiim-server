...
<head>
    ...
    <style type="text/css">
        ...
        .index-button .layui-btn + .layui-btn {
            margin-left: 0;
        }

        .index-button .layui-btn {
            margin: 0 7px 10px 0;
        }
    </style>
</head>
    ...
    <fieldset class="layui-elem-field index-button" style="margin-top: 30px;">
        ...
        <div>
            ...
            <div class="layui-text" style="margin-top:10px; color: #FF5722;">
                <a href="helpdoc.doc" target="_blank" class="layui-btn  layui-btn-sm layui-bg-blue"><i
                        class="layui-icon">&#xe705;</i>查看文档</a>
            </div>
        </div>
    </fieldset>
